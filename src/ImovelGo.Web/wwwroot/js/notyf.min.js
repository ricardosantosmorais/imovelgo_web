var Notyf = function () {
    ...
    var s = function () {
        ...
        return t.prototype.push = function (t) {
            ...
            this.updateFn(n, e.Remove, this.notifications)
        ...
        c = function () {
            ...
            return t.prototype.update = function (t, i) {
                ...
                return n && i.classList.add(n), this.container.appendChild(i), i
            }, t.prototype._popRenderedNotification = function (t) {
                for (var i = -1, n = 0; n < this.notifications.length && i < 0; n++)
                    this.notifications[n].notification === t && (i = n);
                if (-1 !== i)
                ...
                if (n && "object" == typeof n) {
                    ...
                    r && (p.style.color = r), c.appendChild(p), a.appendChild(c)
                }
                return a.appendChild(s), e.appendChild(a), r && (i.ripple ? (o.style.backgroundColor = r, e.appendChild(o)) : e.style.backgroundColor = r), e
    ...
    return function () {
        function t(t) {
            var n = this;
            this.notifications = new s, this.view = new c;
            var i = this.registerTypes(t);
            this.options = o({}, r, t), this.options.types = i, this.notifications.onupdate(function (t, i) {
                n.view.update(t, i)
            })
        }
        ...
        }, t.prototype._pushNotification = function (i) {
            var n = this;
            this.notifications.push(i);
            var t = i.options.duration || this.options.duration;
            setTimeout(function () {
                var t = n.notifications.indexOf(i);
                n.notifications.splice(t, 1)
            }, t)
        }, t.prototype.normalizeOptions = function (t, i) {
            var n = {
                type: t
            };
            return "string" == typeof i ? n.message = i : "object" == typeof i && (n = o({}, n, i)), n
